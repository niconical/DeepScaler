svc_ls = ["frontend", "adservice", "cartservice", "checkoutservice", "currencyservice", "emailservice",
...
for svc in svc_ls:
    for m in metrics:
        t_file = '/ssj/ssj/boutiquessj/pyboutique/newData/3.2.2aws/{}_{}_{}.log'.format(
            iternum, svc, m)
...
cost = 0
cpu_core = {"adservice": 0.3, "cartservice": 0.3, "checkoutservice": 0.2, "currencyservice": 0.2, "emailservice": 0.2,
            "frontend": 0.2, "paymentservice": 0.2, "productcatalogservice": 0.2, "recommendationservice": 0.2, "shippingservice": 0.2}
