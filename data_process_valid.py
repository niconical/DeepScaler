...
file = './data/boutique/valid/1_{}_{}.log'.format(services[8],metrics[0])
...
# "recommendationservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[8],metrics[1])
...
# "shippingservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[9],metrics[1])
...
# "recommendationservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[8],metrics[2])
...
# "shippingservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[9],metrics[2])
...
# "recommendationservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[8],metrics[3])
...
# "shippingservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[9],metrics[3])
...
# "recommendationservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[8],metrics[4])
...
# "shippingservice"
file = './data/boutique/valid/1_{}_{}.log'.format(services[9],metrics[4])
...
# 生成验证集数据
valid_data = read_and_generate_dataset(graph_signal_matrix_filename='./data/boutique/valid.npz',
                                        num_of_hours=1,  # 生成一个小时的数据作为验证集
                                        num_for_predict=1,  # 预测未来 120 个数据点
                                        points_per_hour=60,  # 每小时 120 个数据点
                                        save=True)